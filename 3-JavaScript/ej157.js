//En este caso uso filter porque quiero que solo aparezcan los de una zona específica.
const filtrarPorZona = (zona) => {
    juegos.filter((juego) => { 
        switch (zona) {
            case 1:
...
const juegos = [
    {
        ...
        imprimirEnPantalla: function () {console.log(`${this.nombre}\n$${this.precio}\n${this.cantidadVendida} Vendidos\n${this.localidad}\n`)}    
    },
    {
