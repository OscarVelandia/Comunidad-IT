...
let saboresSinStock = [saboresDeHelado.shift(), saboresDeHelado.shift()];

console.log(`Sabores sin stock: ${saboresSinStock}\nSabores con stock: ${saboresDeHelado}`);

// //Con esto saco los 2 primeros sabores
// let primerSabor = saboresDeHelado.shift(); 
// let segundoSabor = saboresDeHelado.shift();

// //con esto hago un array con los sabores que saqué anteriormente
// let saboresSinStock = [primerSabor, segundoSabor];